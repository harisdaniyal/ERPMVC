...
declare module '@fullcalendar/core' {
    ...
    export {  MemoizedRendering } from '@fullcalendar/core/component/memoized-rendering';
...
declare module '@fullcalendar/core/structs/event' {
    ...
    export function parseEvent(raw: EventInput, sourceId: string, calendar: Calendar, allowOpenRange?: boolean): EventTuple ;
...
declare module '@fullcalendar/core/util/dom-manip' {
    export function createElement(tagName: string, attrs, content?: ElementContent): HTMLElement;
    ...
    export function applyStyle(el: HTMLElement, props): void;
...
declare module '@fullcalendar/core/component/event-splitting' {
    ...
    abstract class Splitter<PropsType > {
...
declare module '@fullcalendar/core/Calendar' {
    ...
    import View from '@fullcalendar/core/View';
    import Theme from '@fullcalendar/core/theme/Theme';
    import { OptionsInput, EventHandlerName } from '@fullcalendar/core/types/input-types';
    ...
    class Calendar {
        ...
        publiclyTrigger<T extends EventHandlerName>(name: T, args?): any;
        publiclyTriggerAfterSizing<T extends EventHandlerName>(name: T, args): void;
        ...
        getUnitViewSpec(unit: string): ViewSpec ;
        getInitialDate(): Date;
        prev(): void;
        next(): void;
        prevYear(): void;
        ...
        addEvent(eventInput: EventInput, sourceInput?: EventSourceApi | string | number): EventApi ;
        getEventById(id: string): EventApi;
        getEvents(): EventApi[];
        removeAllEvents(): void;
        rerenderEvents(): void;
        getEventSources(): EventSourceApi[];
        getEventSourceById(id: string | number): EventSourceApi;
...
declare module '@fullcalendar/core/DateProfileGenerator' {
    ...
    class DateProfileGenerator {
        ...
        initHiddenDays(): void;
        trimHiddenDays(range: DateRange): DateRange ;
...
declare module '@fullcalendar/core/structs/date-span' {
    ...
    export function parseDateSpan(raw: DateSpanInput, dateEnv: DateEnv, defaultDuration?: Duration): DateSpan ;
    export function parseOpenDateSpan(raw: OpenDateSpanInput, dateEnv: DateEnv): OpenDateSpan;
...
declare module '@fullcalendar/core/datelib/duration' {
    ...
    export function createDuration(input: DurationInput, unit?: string): Duration ;
...
declare module '@fullcalendar/core/datelib/formatting' {
    ...
    export type FormatterInput =  string | FuncFormatterFunc;
...
declare module '@fullcalendar/core/structs/event-source' {
    ...
    export type EventInputTransformer = (eventInput: EventInput) => EventInput;
    ...
    export function parseEventSource(raw: EventSourceInput, calendar: Calendar): EventSource;
}
...
declare module '@fullcalendar/core/structs/recurring-event' {
    ...
    export interface RecurringType {
        parse: (rawEvent: EventInput, leftoverProps: any, dateEnv: DateEnv) => ParsedRecurring ;
        expand: (typeData: any, framingRange: DateRange, dateEnv: DateEnv) => DateMarker[];
    }
    export function parseRecurring(eventInput: EventInput, allDayDefault: boolean , dateEnv: DateEnv, recurringTypes: RecurringType[], leftovers: any): {
        allDay: any;
        duration: Duration;
        typeData: any;
        typeId: number;
...
declare module '@fullcalendar/core/common/DaySeries' {
    ...
    class DaySeries {
        ...
        sliceRange(range: DateRange): DaySeriesSeg;
    }
}
...
declare module '@fullcalendar/core/component/event-rendering' {
    ...
    export function getElSeg(el: HTMLElement): Seg ;
...
declare module '@fullcalendar/core/validation' {
    ...
    export type OverlapFunc = ((stillEvent: EventApi, movingEvent: EventApi ) => boolean);
    export type AllowFunc = (span: DateSpanApi, movingEvent: EventApi ) => boolean;
    ...
    export function normalizeConstraint(input: ConstraintInput, calendar: Calendar): Constraint ;
}
...
declare module '@fullcalendar/core/api/EventApi' {
    ...
    class EventApi {
        ...
        setEnd(endInput: DateInput , options?: {
            granularity?: string;
        }): void;
        setDates(startInput: DateInput, endInput: DateInput , options?: {
            allDay?: boolean;
            granularity?: string;
        }): void;
...
declare module '@fullcalendar/core/util/requestJson' {
    export default function requestJson(method: string, url: string, params, successCallback: any, failureCallback: any): void;
}
