...
declare module '@fullcalendar/daygrid/SimpleDayGrid' {
    import { DateProfile, EventStore, EventUiHash, DateSpan, EventInteractionState, DayTable, Duration, DateComponent, DateRange, Hit, ComponentContext } from '@fullcalendar/core';
...
declare module '@fullcalendar/daygrid/DayGrid' {
    ...
    class DayGrid extends DateComponent<DayGridProps> {
        ...
        computeRowLevelLimit(row: any): (number );
