...
{
    public class ExportLogisticRepository : Repository<ExportLogistic>, IExportLogisticRepository
    {
        private ERPMVCEntities _dbContext
        {
            get { return _dbContext as ERPMVCEntities; }
        }
        public ExportLogisticRepository(ERPMVCEntities dbContext) : base(dbContext)
        {
